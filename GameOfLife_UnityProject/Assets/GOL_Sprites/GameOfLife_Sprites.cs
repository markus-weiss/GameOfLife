...
public class GameOfLife_Sprites : MonoBehaviour
{
    ...
    public void Create()
    {
        ...
        for (int i = 0; i < rows / 10; i++)
        {
            for (int a = 0; a < columns / 10; a++)
            {
                ...
                cellArray[i, a].GetComponent<Renderer>().enabled = area[i, a];
    ...
    public void NextGeneration()
    {
        ...
        //    tempArray[i, columns - 1] = false;
        //}
        //for (int i = 0; i < columns; i++)
        //{
        //    tempArray[0, i] = false;

        //    tempArray[rows - 1, i] = false;
        //}
